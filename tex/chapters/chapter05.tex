...
% and $C_0$ represents the number of customers, the percentage of churners and the total losses if 
% no 
% model is used, respectively. Moreover, in \figurename{ \ref{fig:ch5:5}}, a comparison of the 
% churn rate 
% and the average unitary cost ($C_u=C_0 / N$) of each dataset with respect of the Total set is 
% shown.
% It is observed that the cost-sensitive sampling procedures have an average unitary cost much 
% higher 
