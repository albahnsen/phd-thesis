\chapter{Financial risk modeling}\label{ch:3}
...
distribution]{\includegraphics[width=5.5cm]{ch3_fig_1c}\label{fig:von1}}
		\hfill
		\subfloat[Fitted von Mises 
distribution]{\includegraphics[width=5.5cm]{ch3_fig_2c}\label{fig:von2}}
		\\
		\subfloat[Expected time of 
transaction]{\includegraphics[width=5.5cm]{ch3_fig_3c}\label{fig:von3}}
