...
\todo{same example as ch2 but different shades of blue and red}
...
misclassifying a negative example have a cost of $c_0=0.2$ we calculate the respective cost of 
the classification algorithms presented in \figurename{~\ref{fig:2:2b}} (Algorithm1) and 
\figurename{ \ref{fig:2:3}} (Algorithm), and compare the result of the standard measures and the 
class-dependent cost in the following table:
\begin{center}
    \footnotesize
  \begin{tabular}{l|c|c|c|c|c}
  Algorithm & Error & Recall & Precision & $F_1Score$ & $Cost_{cd}$ \\
  \hline
  Algorithm1 & 11.11\% & 87.8\%& 90\%& 88.8\% & \\ %FP = 4 , FN=5
  Algorithm1 & 5.3\% & 90.2\%& 94.9\%& 92.5\% & \\ %FP = 2 , FN=4
  \end{tabular}
\end{center}
