...
\subsection{Example-dependent cost-based evaluation measures}
  ...
  C_{TP_i},C_{FP_i},C_{FN_i},C_{TN_i}]$  and labelled using the class   label $y_i   \in \{0,1\}$. 
...
\todo{Extend description of each method}
    ...
    selecting examples from $\mathcal{S}$, and accepting each example $i$ with probability $w_i/ 
