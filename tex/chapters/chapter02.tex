...
medical field, models have been used for making predictions about tumors, predicting the probability 
of a disease, selecting the right drug for a particular patient, and estimating the probability of 
relapsing, among others \citep{Herland2014}. In the financial section, models have been successfully 
used for fraud detection, credit scoring and algorithmic trading. In marketing, several models are 
being currently used for churn modeling, customer targeting, behavior prediction and direct 
marketing \citep{Baesens2014}. Not to mention other emerging applications such as terrorism 
prevention, malware detection, spam classification, and others \citep{Kriegel2007}.
\todo{More examples}
\end{remark}
