...
marketing. The results show that the proposed methods outperforms state-of-the-art example-dependent 
  ...
  Finally, our results show that there are significant differences in the 
  ...
  conclusion of the importance of using the real example-dependent financial costs 
  associated with real-world applications
