\chapter{Ensembles of cost-sensitive decision trees}\label{ch:8}
...
&CSRP-s-t & 0.2956 &$\pm$& 0.0078 & 0.4878 &$\pm$& 0.0080\\ 
  ...
  \end{tabular}
    \caption{Continuation of \tablename{~\ref{tab:8:results_savings}}}
    \label{tab:8:results_savings2}
  \end{table}
  ...
  method. Moreover as shown in  \tablename{~\ref{tab:8:results_best}}, this method ranks on each 
  ...
  \ref{fig:8:comparison_best}}. Even that ranks of the $BMR$ models are better than the $CSDT$, the 
...
\end{figure}
 ...
 \begin{figure}[!t]
  ...
  \label{fig:8:rank_ecsdt}
\end{figure}
 
  Furthermore \figurename{~\ref{fig:8:family_rank}}, shows the Friedman ranking of each family of 
  ...
  \figurename{~\ref{fig:8:family_avgsav}}. However, in the case of the perBest, the $CST$ methods 
  ...
  methods and by the combination approach. In \figurename{ \ref{fig:8:rank_ecsdt1}}, the Friedman 
  ...
  \ref{fig:8:rank_ecsdt2}}, a similar analysis is made taking into account the combination of base 
  ...
  65.10\%.}
  \label{fig:8:friedman_vs_fscore}
  \end{figure}
...
&CSRP-s-t & 0.3720 &$\pm$& 0.0049 & 0.2922 &$\pm$& 0.0137\\ 
    ...
    \end{tabular}
\caption{Continuation of \tablename{~\ref{tab:8:results_f1score}}}
\label{tab:8:results_f1score2}
  \end{table}

  Finally, in \tablename{~\ref{tab:8:results_f1score}} the results of the algorithms measured by 
  ...
  be  further examined in \mbox{\figurename{~\ref{fig:8:friedman_vs_fscore}}}, where the ranking of 
