...
\label{sec:7:ga}
\todo{Djamila: this section can: move to background, leave here, or be deleted.}
...
In particular, we are interested in compared the results of the different logistic regression 
