...
\label{sec:4:frad:eval}
  ...
  Most of these studies compare they proposed algorithm with a benchmark algorithm and then make 
	...
	algorithm $c_i$ is a function of  the $k$ features of example $i$, 
\mbox{$\mathbf{X}_i=[\mathbf{x}_i^1, 
	\mathbf{x}_i^2,...,\mathbf{x}_i^k]$} and $y_i$ is the true class of the example $i$.
